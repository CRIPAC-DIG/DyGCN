...
class Loader(object):
    def __init__(self, flag):
        if platform.system() == 'Linux':
            self.path_init_file = path_init_file = '/home/cuizeyu/pythonfile/dynGCN/data/data_arti/'
            self.path_file = path_file = './data/data_arti/'
            # path_init_file = '/home/hufenyu/Documents/pythonfile/dataset/'
            # path_file = '/home/hufenyu/Documents/pythonfile/lightrnn_czy/data/'

        else:
            self.path_init_file = path_init_file = '/Users/czy_yente/PycharmProjects/dynGCN/data/data_arti/'
            self.path_file = path_file = './data/data_arti/'

        with open(path_init_file + "node2id.json", 'r') as f:
            self.node2id = node2id = json.load(f)

        self.embedding_path = 'arti_train_embedding/'
